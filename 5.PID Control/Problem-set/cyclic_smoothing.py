...
for i in range(len(testpath1)):
    plt.scatter(testpath1[i][0],testpath1[i][1], color='red', alpha=0.4)
    plt.scatter(smooth(testpath1)[i][0],smooth(testpath1)[i][1],color='blue')
plt.legend(['original path','Smoothed path'])
plt.title('Path Smoothing Algorithm - TEST 1')
plt.show()

for i in range(len(testpath2)):
    plt.scatter(testpath2[i][0],testpath2[i][1], color='red', alpha=0.4)
    plt.scatter(smooth(testpath2)[i][0],smooth(testpath2)[i][1],color='blue')
plt.legend(['original path','Smoothed path'])
plt.title('Path Smoothing Algorithm - TEST 2')
plt.show()